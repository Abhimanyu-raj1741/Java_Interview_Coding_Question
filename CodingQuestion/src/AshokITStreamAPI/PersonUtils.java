...
public class PersonUtils {
	...
	public static List<Person> getCustomerData(){
		...
		Person p3 = new Person(1,"Satish","Hyderabad",23,Arrays.asList(homeAddress,officeAddress));
		Person p4 = new Person(1,"Rakesh","Jharia",21,Arrays.asList(homeAddress,officeAddress));
		Person p5 = new Person(1,"Rakesh","Katras",24,Arrays.asList(homeAddress,officeAddress));
		Person p6 = new Person(1,"Ankit","Ranchi",26,Arrays.asList(homeAddress,officeAddress));
